document.addEventListener("DOMContentLoaded", () => {
  ...
  function resetProfileForm() {
    const displayName =
      document
        .querySelector('.profile-value[data-field="display_name"]')
        ?.textContent.trim() || "";
    const email =
      document
        .querySelector('.profile-value[data-field="email"]')
        ?.textContent.trim() || "";
    const bio =
      document
        .querySelector('.profile-value[data-field="bio"]')
        ?.textContent.trim() || "";

    document.getElementById("displayNameInput").value =
      displayName === "Не указан" ? "" : displayName;
  ...
  function showProfileErrors(errors) {
    ...
    ["DisplayName", "Email", "Bio", "NewPassword", "RepeatPassword"].forEach(
      (field) => {
    ...
    if (errors.display_name)
      document.getElementById("errorDisplayName").textContent =
        errors.display_name;
    if (errors.email)
      document.getElementById("errorEmail").textContent = errors.email;
    if (errors.bio)
      document.getElementById("errorBio").textContent = errors.bio;
